...
{
	 	//已学习章节
		public partial class tb_UserLearnChapter
	{
	    #region 成员
        /// <summary>
        /// 表名
        /// </summary>
        private readonly string TableName = "tb_UserLearnChapter";
        #endregion
   		     
	    /// <summary>
		/// 增加一条数据
		/// </summary>
		public bool Add(TiKu.Model.tb_UserLearnChapter model)
		{
		  return EntityQuery<TiKu.Model.tb_UserLearnChapter>.Instance.Add(model);
		}
   		     
	    /// <summary>
		///修改
		/// </summary>
	   public bool Update(TiKu.Model.tb_UserLearnChapter model)
	   {
	    return EntityQuery<TiKu.Model.tb_UserLearnChapter>.Instance.Update(model);
	   }
	   
	   	 /// <summary>
		///删除
		/// </summary>
	   public int Delete(TiKu.Model.tb_UserLearnChapter model)
	   {
	    return EntityQuery<TiKu.Model.tb_UserLearnChapter>.Instance.Delete(model);
	   }
        ...
        /// <returns></returns>
        public TiKu.Model.tb_UserLearnChapter GetModel(int ID)
        {
            TiKu.Model.tb_UserLearnChapter model = new TiKu.Model.tb_UserLearnChapter();
            model.ID=ID;
            EntityQuery<TiKu.Model.tb_UserLearnChapter>.Instance.Fill(model);
            return model;
        }
        ...
        /// <returns></returns>
        public List<TiKu.Model.tb_UserLearnChapter> GetList(int top,
            string where,
            string orders,
            IEnumerable parameters)
        {
            List<TiKu.Model.tb_UserLearnChapter> list = TiKu.DataDriver.Entity.EntityQuery<TiKu.Model.tb_UserLearnChapter>.Instance.GetList(top,
                                                                               "ID,UserID,ChapterID,AddTime",
                                                                               "tb_UserLearnChapter",
                                                                               where,
                                                                               orders,
                                                                               parameters);
        ...
        /// <returns></returns>
        public List<TiKu.Model.tb_UserLearnChapter> GetListPager(int startIndex,
                                                    int endIndex,
                                                    string where,
                                                    string orders,
                                                    IEnumerable parameters,
                                                    out int iRowCount)
        {
            ...
            stbCmdText.AppendFormat("SELECT Row_Number() over(order by ID desc) as Row,ID,UserID,ChapterID,AddTime FROM [{0}] WHERE 1=1 ",TableName);
            ...
            List<TiKu.Model.tb_UserLearnChapter> list = new List<TiKu.Model.tb_UserLearnChapter>();
