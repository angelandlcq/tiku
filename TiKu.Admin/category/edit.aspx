<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="TiKu.Admin.category.edit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>课程分类信息-<%=WebName%></title>
    ...
    <form id="form1" runat="server">
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="javascript:;">课程分类信息</a></li>
            </ul>
        </div>
        <div class="formbody">

            <div class="formtitle"><span>课程分类信息</span></div>

            <ul class="forminfo">
                <li>
                    <label>分类名称<b>*</b></label><input id="txtTitle" placeholder="请输入2-60个字符" datatype="*2-80" errormsg="请输入2-60个字符" runat="server" maxlength="60" type="text" class="dfinput" /><i class="Validform_checktip">标题不能超过60个字符</i></li>
                <li>
                    <label>所属分类</label>
                    <div class="vocation">
