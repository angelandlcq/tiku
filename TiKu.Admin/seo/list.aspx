<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="TiKu.Admin.seo.list" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <li><a href="javascript:void(null);">SEO设置</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <li>
          <a href="edit.aspx?action=add">
           <span><img src="/images/t01.png" alt="添加"/></span>添加
          </a>
        </li>
        </ul>
    </div>
    <!--查询-->
    <ul class="seachform">  
    <li><label>关键词</label><input runat="server" id="txtKeywords"  maxlength="30" type="text" class="scinput" /></li>        
