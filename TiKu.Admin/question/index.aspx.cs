...
/*=================================================================================================
 * 
 * className:Admin题库信息（UI）
 * author:1058736170@qq.com
 * date:2015-03-26 10:13
 * modifyBy:1058736170@qq.com
 * modifyOn:2015-03-26 10:13
...
namespace TiKu.Admin.question
{
    public partial class index : TiKu.WebUI.Page.AdminBase
    {
        ...
        /// BLL组件
        /// </summary>
        protected readonly BLL.tb_Question bll = new BLL.tb_Question();
        ...
        protected void RepList_OnItemCommand(object sender, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("/q/course.aspx?action=edit&id={0}", iID));
            }
        }
