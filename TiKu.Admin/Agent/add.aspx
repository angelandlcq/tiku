<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="TiKu.Admin.Agent.add" %>
<!DOCTYPE html>
...
<form id="form1" runat="server">
        ...
        <div class="formbody">
            ...
            <ul class="forminfo">
                <li>
                    <label>登录名<b>*</b></label><input id="txtAgentName" ajaxurl="/tools/AjaxSubmit.ashx?action=checkAgentName" datatype="s6-30" nullmsg="请输入登录名" errormsg="请输入6-30个字符" runat="server" maxlength="30" type="text" class="dfinput" /><i class="Validform_checktip">登录名不能超过30个字符</i></li>
                <li>
                ...
                <li>
                 ...
                 <li>
                    <label>旺旺号</label><input id="txtAliAccount"  runat="server" maxlength="100" ignore="ignore" type="text" class="dfinput" /><i class="Validform_checktip">淘宝店铺地址</i></li>
                                 <li>
                ...
                <li>
                 ...
                 <li>
                    <label>登录密码<b>*</b></label><input id="txtPwd" datatype="s6-16" nullmsg="请输入登录密码！" errormsg="请输入6-16个字符" runat="server" maxlength="16" type="password" class="dfinput" /><i class="Validform_checktip">请输入6-16个字符</i></li>
                                 <li>
                    <label>再次输入<b>*</b></label><input id="txtConfirmPwd" recheck="txtPwd" datatype="s6-16" nullmsg="请输入登录密码！" errormsg="两次输入不一致！" runat="server" maxlength="16" type="password" class="dfinput" /><i class="Validform_checktip"></i></li>
                <li>
                    <label>&nbsp;</label>
