<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TiKu.Admin.course.index" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>专业科目-<%=WebName%></title>
...
<body>
  <form id="form1" runat="server">
    ...
    <li><a href="javascript:void(null);">专业科目</a></li>
    </ul>
    </div>
    ...
    <!--查询-->
    <ul class="seachform">  
    <li><label>综合查询</label><input id="txtKeywords" runat="server" type="text" class="scinput" /></li>        
    <li><label>课程分类</label>  
    <div class="vocation">
     <asp:DropDownList runat="server" CssClass="select3" Width="160" ID="DrpCategory">
     </asp:DropDownList>
    </div>
    </li>
        ...
        <asp:Repeater runat="server" ID="RepList" OnItemCommand="RepList_OnItemCommand">
         <ItemTemplate>
           <tr>
                ...
                <td><%#Eval("CateName")%></td>
                <td><%#Eval("Orders")%></td>
                <td><%#bll.ShowStateLabel(Eval("State"))%></td>
                <td>
            <asp:LinkButton runat="server" ID="btnDelete" OnClientClick="return confirm('确定要删除吗？');" 
            CommandName="delete" CommandArgument='<%#Eval("ID")+"|"+Eval("CategoryID")%>' CssClass="tablelink" Font-Underline="true">
